"""Script for training Data2Vec model using the denoising approch"""
...
from data2vec.data2vec_utils.trainer_denoising import train, evaluate
from utils.dataset_denoising import get_denoising_loader
...
def training_pipeline(config):
    ...
    trainloader = get_denoising_loader(train_student_list, train_teacher_list, config, train=True)
